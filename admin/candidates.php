...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Candidate Management</title>
...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <button type="button" class="btn btn-outline-primary btn-sm" onclick="editCandidate(<?php echo $candidate['id']; ?>)">Edit</button>
    ...
    <script>
        function editCandidate(id) {
            // This would fetch candidate data and populate the modal
            // For now, just open the modal for adding new candidate
